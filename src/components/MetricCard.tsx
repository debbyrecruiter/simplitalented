...
export function MetricCard({
  ...
  return (
    <Card 
      className={cn(
        "border-4 border-blue-500 bg-[#F0F0FF] rounded-xl shadow-sm aspect-square flex flex-col scale-75", 
    ...
    >
      <CardHeader className="flex flex-row items-center justify-center text-center pb-0 pt-12">
        ...
        {Icon && (
          <div className="absolute right-6 h-8 w-8 rounded-md bg-[#F0F0FF]/50 flex items-center justify-center">
