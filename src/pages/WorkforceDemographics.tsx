      ...
      <div className="flex-1 p-4 overflow-auto bg-background">
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-8">
          <div className="flex-1 min-w-[300px] max-w-[400px]">
            <Card 
              className={`card-modern cursor-pointer w-full shadow-lg ${selectedCategory === "gender" ? "ring-4 ring-white/50" : ""}`}
          ...
          <div className="flex-1 min-w-[300px] max-w-[400px]">
            <Card 
              className={`card-modern cursor-pointer w-full shadow-lg ${selectedCategory === "race" ? "ring-4 ring-white/50" : ""}`}
          ...
          <div className="flex-1 min-w-[300px] max-w-[400px]">
            <Card 
              className={`card-modern cursor-pointer w-full shadow-lg ${selectedCategory === "age" ? "ring-4 ring-white/50" : ""}`}
